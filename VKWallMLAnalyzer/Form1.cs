...
namespace VKWallMLAnalyzer
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Start_BTN_Click(object sender, EventArgs e)
        {
            ...
            var outer = Task.Factory.StartNew(() =>      // внешняя задача
            {
                ...
                for (int currentAccount = 0; currentAccount < accountQuantity; currentAccount++)
                {
                    ...
                    wall = _ApiRequest.GetWallTexts(target, 100 * currentAccount);
        ...
        private void Search_BTN_Click(object sender, EventArgs e)
        {
            ...
            List<string[]> data = DBHelper.GetInfoByKeywords
                (Search_ID_TB.Text, Search_Keywords_TB.Text, Search_TargetType_CB.Text);
